...
python .agents/skills/research-industry-chain/scripts/normalize_research_inputs.py --input leaders.csv --table global_leaders --pretty
python .agents/skills/research-industry-chain/scripts/normalize_research_inputs.py --input research.json --out normalized.json
```
