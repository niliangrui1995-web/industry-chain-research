...
- 公告窗口：在北京时间 20:00 后完成 T=`2026-09-02` 与可访问 T+1=`2026-09-03` 检查。CNINFO 精确代码加 `orgId` 查询返回 0；逐公司公司名复核命中实际控制人部分股票质押、股东名册和 H 股下一交易日披露表三份文件，深交所 `annList` HTTP 500 保留为 `source_gap`。
- 质押事实：实际控制人王伟修新增质押 728,000 股，占其所持股份 1.04%、公司总股本 0.06%，用途为偿还债务；实际控制人及一致行动人合计质押占其所持股份 3.45%、占公司总股本 0.57%。公告称不存在与上市公司相关的重组业绩补偿义务。
- 其余文件：股东名册与 H 股表格未提供客户、订单、产品出货、收入或资本配置的新事实，未单列 event。
- 龙虎榜 / 大宗交易：2026-09-02 深交所逐公司公开信息均为 `recordcount=0`。
- 相对基线：质押仅新增治理、融资与交易结构观察，不改变 800G、1.6T、硅光或 NPO 的既有收入阶段及基本面判断。

## 2026-08-27 晚间 T/T+1 复扫

- 公告窗口：CNINFO 命中 H 股调入港股通标的和悉数行使超额配售权两份正式公告；深交所 annList HTTP 500 继续作为 source_gap。
- H 股资本市场进展：公司悉数行使 8,175,000 股超额配售权，行使价 980 港元/股；H 股总数增至 62,675,000 股、占总股本约 5.32%，新增 H 股预计 2026-08-31 上市。公司 H 股已于 8 月 27 日调入港股通标的。
- 龙虎榜 / 大宗交易：深交所龙虎榜记录为 0；大宗交易接口存在同一笔 1.48 万股、约 1,281.86 万元的重复记录，按去重后一笔保留为低重要性观察，未归因于经营。
- 相对基线：融资与流动性结构变化，不构成 800G/1.6T、硅光客户、订单、收入或毛利率新增证据，thesis_effect=unchanged。
metadata:
- company: 中际旭创股份有限公司
- ticker: 300308.SZ
- exchange: SZSE
...
- 公告窗口：检查 2026-07-17 至 2026-07-21。公司 H 股发行已取得中国证监会备案通知，可发行不超过 94,004,350 股境外上市普通股；7 月 16 日通过港交所上市聆讯，7 月 17 日发布聆讯后资料集。港交所明确聆讯通过不等于上市批准，后续仍存在监管意见、发行条件和摊薄不确定性。
- 龙虎榜：7 月 17、20 日均未命中。
- 大宗交易：7 月 17 日 1 笔平价交易，979.46 元、39.49 万股、38,679.17 万元，买方机构专用，卖方招商证券深圳湾科技生态园证券营业部。
- open-web：未发现 800G/1.6T、订单、客户、物料或毛利率的新增可靠公司级事实；社交平台对板块回撤的讨论只保留为观察，不作归因。
- 状态变化：H 股发行从申报推进至聆讯后资料集阶段，资本市场里程碑增强；经营主线仍以在手订单、1.6T/800G 需求、毛利率、现金流和物料供给为准，大宗交易不作经营解读。

## 2026-07-29 日更

- 公告窗口：回扫公告日期 `2026-07-21` 至 `2026-07-29`；20:00 前运行，晚间公告待复扫。
- H 股发行：基础发售 5,450 万股 H 股，其中香港公开发售 545 万股、国际发售 4,905 万股，另有最多 817.5 万股超额配售权；最终发售价为每股 980 港元，预计 7 月 30 日在港交所挂牌。
- 重要性：股份转让尚需深交所合规性确认及中国结算深圳分公司办理过户登记；公司对数据中心高功率密度下热管理、EMI 屏蔽协同的表述属于预期协同，不能外推为已形成 800G/1.6T 客户、订单、收入或利润。
- 交易与来源：深交所 annList 本轮 HTTP 500，按 source_gap 记录；东方财富二级龙虎榜与大宗交易逐项查询未命中。
- 相对基线：该事项是资本配置/产业协同路径变化，不改变既有产品商业化阶段，`thesis_effect=unchanged`。下一步只以交易所确认、股份过户、后续财报中可量化的协同收入、利润和现金流为准。

## 2026-08-21 日更

- 公告窗口：北京时间 20:00 后核验 `2026-08-21` 与 `2026-08-22`；CNINFO T+1 披露半年度报告及摘要，深交所 annList 返回 HTTP 500。龙虎榜为 0；大宗交易接口存在同一 8,000 股、754.40 万元平价记录的重复行，按数据格式异常不计入事件。
- 半年报：公司披露营收 417.78 亿元、归母净利润 136.51 亿元、扣非归母净利润 130.92 亿元，分别同比增长 182.49%、241.70%、229.32%；经营现金流 18.00 亿元、同比下降 44.08%。
- 产品与质量：公司称 800G、1.6T 产品出货和占比继续提升，1.6T 硅光模块进入规模放量阶段；光通信收发模块收入 413.55 亿元、毛利率 46.59%。同时应收账款升至 150.01 亿元、存货升至 198.26 亿元，需以回款与周转验证业绩质量。
- 资本配置：董事会拟每 10 股派发现金红利 12 元，合计约 14.04 亿元。相对基线，`INNO-01` 得到正式增强，`INNO-03` 的营运资本风险同步提高；下一代产品仍不得外推为新增客户订单。

## 2026-08-24 日更

- 公告窗口：北京时间 20:00 后以巨潮代码与 `orgId` 查询 `2026-08-24` 至 `2026-08-25` 为 0，深交所 `annList` 返回 HTTP 500。最近 24 小时的单公司联网发现 2026-08-23 电话会议《投资者关系活动记录表》，公开 PDF 镜像经文件签名和全文核验；未取得巨潮或公司 IR 原始链接，按 `confirmed_secondary` 管理层口径记录。
- 管理层主张：公司称主要客户已给出 2027 年指引和订单，800G/1.6T 需求仍将快速增长；NPO 正在按客户要求定制开发并送样，预计 2027 年有望出货；部分客户正洽谈长协。公司亦称关键物料仍偏紧、通过预付/锁料/长协保障交付，并称应收、存货和长期预付款上升与出货和提前备料有关。
- 相对基线：上述均是公司最新管理层表述，未披露客户名称、订单金额、约束性条款、1.6T/800G 独立收入、NPO验收、收入、良率或现金回款；NPO 仍停留 `sampling`，800G/1.6T 的既有收入阶段不变，核心 thesis `unchanged`。

## 2026-08-28 晚间复扫

- 公告窗口：已复核 `2026-08-28` 与 `2026-08-29`；CNINFO 和深交所交叉未见新的发行人经营公告，深交所 annList HTTP 500 按 `source_gap` 记录。联网观察没有可升级为客户、订单、800G/1.6T 或硅光收入事实的新信息。
- 交易：2026-08-27 东方财富 RPT_DATA_BLOCKTRADE 按 DAILY_RANK 返回两笔机构对机构平价成交，每笔 14,800 股、1,281.86 万元；合计 29,600 股、2,563.72 万元，成交价 866.12 元等于当日收盘价，合计约占总股本 0.0025%。未取得深交所原始回读，故仅为 `confirmed_secondary`。
- 相对基线：小比例平价换手不改变 H 股资本市场进展，也不构成 800G、1.6T、硅光或 NPO 的客户、订单、收入和毛利率证据，`thesis_effect=unchanged`。

## 2026-08-31 晚间日更

- 公告窗口：北京时间 20:00 后完成 `2026-08-30`、`2026-08-31` 与可访问的 `2026-09-01` T/T+1 回扫。CNINFO 确认 8 月 31 日董事会通过、9 月 1 日披露的回购方案。
- 资本配置：拟以 4 亿至 8 亿元回购股份，价格上限 1,200 元/股，拟用于员工持股计划或股权激励，期限 12 个月；该事项尚未形成实际回购，亦不构成高速光模块客户、订单或收入证据。
- 龙虎榜 / 大宗交易：二级查询返回 `code=9201` 空结果，不等于交易所官方零记录。
- 相对基线：回购方案属于资本配置，800G、1.6T、硅光与 NPO 的客户、订单、收入和毛利率证据没有变化，`thesis_effect=unchanged`。

## 2026-09-01 晚间日更

- 公告窗口：北京时间 20:00 后完成 `2026-09-01` 与 `2026-09-02` T/T+1 核验。CNINFO 确认 9 月 2 日披露的《首次回购公司股份公告》及《回购报告书》。
- 首次实际执行：公司于 9 月 1 日集中竞价回购 374,100 股，占当前总股本 0.0318%，成交价 838.16 元/股至 870.00 元/股，成交总金额 318,402,795.70 元（不含交易费用）。
- 相对基线：这将 8 月 31 日已入账的回购方案推进为首次实际执行；仍仅为资本配置，未新增 800G、1.6T、硅光或 NPO 的客户、订单、出货、收入、毛利率或现金回款证据，`thesis_effect=unchanged`。
- 交易与下一步：9 月 1 日深交所龙虎榜和大宗交易逐公司查询为 0；该结果不预测回购节奏或价格方向。后续核验累计回购、资金来源实际使用、股份用途，以及分产品收入、客户订单和营运现金流。

## 2026-09-03 晚间日更

- 公告窗口：CNINFO 公司名查询命中 1 份 H 股翌日披露报表；SZSE annList 返回 HTTP 500，作为 source_gap 保留。
- 分类：该例行 H 股股本/库存股披露未见新的董事会授权、经营指标或客户订单，不重复扩展既有 A 股回购资本配置事件。
- 龙虎榜/大宗交易：SZSE ShowReport 对 9 月 3 日逐公司查询均为 recordcount=0；基本面 thesis_effect=unchanged。

## 2026-09-05 日更（20:00 前）

- CNINFO 2026-09-04 确认实际控制人王伟修于 9 月 3 日解除质押 1,350,000 股；截至该日实际控制人及一致行动人累计质押 5,328,000 股，占其所持 2.76%、公司总股本 0.45%。该治理/交易结构事实已入账，不改变高速光模块收入阶段。
- CNINFO 同日确认拟向控股子公司广东深度智冷科技有限公司提供不超过 5,100 万元、利率 2.70%、期限 12 个月的财务资助；另一股东拟提供不超过 4,900 万元但仍待审批。子公司 2026H1 净亏损 19,240,900 元，实际放款、资金回收和液冷客户/收入均未确认，已按资本配置与风险观察入账。
- 同期两份 H 股翌日披露报表为例行事项；2026-09-04 SZSE 龙虎榜及大宗交易逐公司查询为 recordcount=0，annList HTTP 500 保留 source_gap。
- 相对基线：800G、1.6T、硅光、NPO 与液冷业务均未新增客户、订单、出货、收入、毛利率或现金回款硬证据，`thesis_effect=unchanged`；晚间复扫待完成。
