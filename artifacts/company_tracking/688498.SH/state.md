...
- 公告窗口：北京时间 20:00 后按 `2026-08-28` 与 `2026-08-29` 逐公司核验；CNINFO 命中 T+1 标示日期的 2026H1 报告、分红方案、资产减值等文件，上交所查询返回 200 响应但未取得可消费的发行人记录，以 CNINFO 原文为主。报告在 8 月 28 日晚间已可公开访问，保留 8 月 29 日公告标示日期。
- 财务事实：2026H1 营收 9.2515 亿元、归母 6.0707 亿元、扣非 5.1444 亿元、经营现金流 4.8767 亿元，同比分别 +351.40%、+1212.20%、+1033.70%、+729.67%，四项同比的 financial-evidence-audit 均为 PASS。数据中心业务收入 7.7422 亿元、同比 +640.29%。
- 产品边界：公司披露 CW 70mW/100mW 已批量出货，100G PAM4 EML 开始批量出货；200G PAM4 EML 仍处客户验证。没有 CW/EML 单产品收入、毛利率、具名客户、订单金额/数量或回款，因此不升级为产品级收入或客户订单事实。
- 反证与资本配置：半年度资产减值准备合计 2,329.44 万元；中期拟每 10 股派 10 元，按公告测算拟派现 1.2423 亿元，实际以权益分派实施为准。上述两项不改变产品商业化判断。
- 交易与联网观察：2026-08-27、08-28 龙虎榜和大宗交易二级查询未返回匹配记录；联网观察仅复述正式中报，无新增客户、订单或行业硬证据。相对基线，正式财务结果与数据中心收入增强可核验度，但因原档案没有可变更的稳定假设 ID、且客户/单产品财务拆分缺失，`thesis_effect=unchanged`。

## 2026-09-03 晚间日更

- 公告窗口：CNINFO 命中 9 月 3 日半导体行业集体业绩说明会公告及 9 月 4 日工商变更/换发营业执照公告；SSE 公司公告接口为 0，保留来源可见性差异。
- 分类：说明会为 9 月 10 日沟通安排，工商变更落实此前程序；均未确认新增产能、客户、订单、收入或 CW/EML 产品阶段，未追加 event。
- 龙虎榜/大宗交易：SSE 科创板交易公开信息未命中；逐证券大宗交易官方回读为 source_gap。重点等待说明会原始问答。

## 2026-09-05 日更（20:00 前）

- CNINFO 再次可检出 9 月 4 日工商变更及换发营业执照公告；该事项已在上一轮归类为此前注册资本/章程程序的落实，不重复追加 event。
- SSE 科创板交易公开信息未命中；逐证券大宗交易官方回读仍为 source_gap，未发现新增产能、客户、订单、收入或 CW/EML 产品阶段证据。
- 相对基线：200G PAM4 EML 仍待客户验证，`thesis_effect=unchanged`；晚间复扫及业绩说明会原始问答待核验。
