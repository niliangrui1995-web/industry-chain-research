...
东山精密处在“传统电子制造基本盘 + AI PCB/光模块重估”的加速验证期。2025 年光模块仅并表四季度，但已经贡献 14.36 亿元收入和 36.74% 毛利率；2026Q1 和 2026H1 业绩预告显示索尔思并表和 AI 光通信需求已经改变利润弹性。7 月 15 日投关记录进一步确认公司具备光芯片全流程 IDM 体系，光芯片和光模块扩产推进、良率仍在优化。当前最需要跟踪的不是“有没有 AI 叙事”，而是 AI PCB 与光模块能否持续披露客户、订单、毛利率、产能爬坡和现金流证据。

## 2026-07-16 日更

- 公告窗口：北京时间 20:00 后完成 `2026-07-16` 与 `2026-07-17` 的 T/T+1 检查；CNINFO 新增披露 7 月 15 日机构投资者会议记录。
- 光芯片/光模块：公司称具备完整的光芯片全流程 IDM 体系，光芯片及光模块产能扩建有序推进，后续交付将结合客户订单安排；当前仍处产能投放期，良率持续优化。
- AI PCB：公司将其定位为重点进攻赛道，并强调“光模块（含光芯片）+ AI PCB”协同；该表述是战略和能力口径，不是具名客户、订单、产能或收入确认。
- 龙虎榜 / 大宗交易：2026-07-16 未发现新增龙虎榜或大宗交易。
- 状态变化：相对 7 月 15 日业绩预告，新增 IDM、扩产与良率阶段的正式 IR 说明；由于没有产能、良率、订单和分业务利润量化，不进一步上调经营兑现等级。

## 2026-07-15 日更

- 公告窗口：北京时间 20:00 后完成 2026-07-14、2026-07-15 与 T+1 2026-07-16 检查；CNINFO 确认 7 月 15 日新增《2026 年半年度业绩预告》。
- 新增官方业绩事件：公司预计 2026H1 归母净利润 29 亿至 30 亿元，同比增长 282.58% 至 295.78%；扣非归母净利润 24 亿至 25 亿元，同比增长 265.41% 至 280.63%。公司称传统消费电子和汽车零部件业务稳定改善，光模块整合效应显现，新产能爬坡、新客户导入符合预期，且此前数据中心相关投资已形成收益并增厚利润。
- 龙虎榜：深交所确认 2026-07-14 因日价格涨幅偏离值达到 7.74% 上榜，成交 95,468,607 股、金额 238.56 亿元；东方财富汇总口径显示榜单买入约 42.07 亿元、卖出约 28.72 亿元、净买入约 13.35 亿元，深股通与多家机构席位双向活跃。
- 大宗交易：2026-07-15 有 1 笔平价小额交易，成交价 262.49 元、1.00 万股、262.49 万元，规模很小，不追加为实质事件。
- 状态变化：光模块整合、新产能爬坡和新客户导入首次获得半年度业绩预告的正式经营验证；但归母与扣非预告区间相差约 5 亿元，且公司明确数据中心相关投资形成收益，因此不能把全部利润增长归因于光模块或 AI PCB 经营利润。龙虎榜显示交易拥挤和波动风险继续上升。

## 2026-07-09 日更
- 公告窗口：北京时间 20:00 后完成 `2026-07-09` 与 `2026-07-10` 的 T/T+1 检查；CNINFO 未发现新增发行人公告或 IR。
- 龙虎榜：2026-07-09 东山精密因日涨幅偏离值达到 7% 的前 5 只证券上榜，收盘 261.32 元、涨幅 10.0017%、换手率 8.1039%，榜单买入约 36.15 亿元、卖出约 30.92 亿元、净买入约 5.23 亿元。
- 大宗交易：2026-07-09 未发现新增大宗交易；2026-07-08 回扫无新增。
- 状态变化：索尔思/AI PCB 预期下的交易拥挤度继续维持高位，交易弹性和波动风险同步上升；经营主线仍需订单、客户、收入、毛利率、产能爬坡和现金流证据闭环。
...
- 龙虎榜：深交所竞价交易公开信息确认东山精密 2026-07-03 因日价格振幅达到 18.85% 上榜，成交量 124,201,247 股、成交金额 27,821,158,389 元。席位明细显示深股通专用同时居买一和卖一；机构专用在买二、买三、买四及卖二、卖三、卖四、卖五均出现。东方财富汇总口径显示榜单买入约 42.62 亿元、卖出约 31.37 亿元、净买入约 11.25 亿元。
- 大宗交易：2026-07-03 未发现新增大宗交易。
- 状态变化：7 月 2 日下跌上榜后，7 月 3 日继续因高振幅上榜，说明索尔思/AI PCB 预期下的交易分歧和拥挤度仍高；这仍是交易结构信号，不等于光模块、AI PCB 或索尔思经营基本面被证实或证伪。
...
| 日期 | 证据 | 判断 |
|---|---|---|
| 2026-07-16 | CNINFO《投资者关系活动记录表 20260715》：公司称具备完整光芯片全流程 IDM 体系，光芯片及光模块扩产有序推进，良率持续优化，交付结合客户订单安排 | 补强技术与扩产阶段证据，但缺少产能、良率、订单和利润量化，不把 AI PCB 战略表述升级为经营兑现 |
...
- 龙虎榜：深交所竞价交易公开信息确认东山精密 2026-07-02 因日价格跌幅偏离值达到 -7.19% 上榜，成交金额 188.50 亿元；深股通专用同时位列买一和卖一，机构专用在买卖席位中均活跃，东方财富汇总口径显示榜单净卖出约 6.67 亿元。
- 大宗交易：2026-07-01 与 2026-07-02 未发现新增大宗交易。
- open-web：普通联网搜索主要返回龙虎榜、行情、旧扩产报道和卖方/媒体观点，未发现新的客户、订单、收入、毛利率或产能爬坡官方硬证据。
- 状态变化：索尔思/AI PCB 高预期后的交易拥挤和回撤风险显著上升；该事件是交易结构信号，不代表光模块、AI PCB 或索尔思经营基本面已出现正式披露层面的恶化。
...
- 公告窗口：北京时间 20:00 后完成 `2026-06-18` 与 `2026-06-19` 的 T/T+1 检查；CNINFO 公司名/代码查询未发现新增正式公告，昨日 12 亿美元扩产和 IR 记录不重复入账。
...
- 公告窗口：北京时间 20:00 后按公司精确参数复核公告日期 `2026-07-29` 与 `2026-07-30`；CNINFO、深交所与公司公开披露未发现早间记录之外的新增正式公告，`announcement_window_checked=T_and_T_plus_1`。
- 延迟补录：可信媒体于 7 月 23 日一致转述公司互动平台回复，Source Photonics 一批光模块于 2026 年 6 月在运输途中丢失，公司已报案并报险。公司称货物已充分投保、预计全额获赔，相关损失对利润不构成重大影响且低于上一年度经审计净利润的 10%。
...
- 公告窗口：北京时间 20:00 后核验 `2026-08-21` 与 `2026-08-22`；CNINFO T+1 披露半年度报告、境外扩建、注资、担保及资产核销等文件；深交所 annList 返回 HTTP 500；龙虎榜和大宗交易二级查询均为 0。
- 半年报：公司披露营收 277.98 亿元、归母净利润 29.57 亿元、扣非归母净利润 24.80 亿元，分别同比增长 63.95%、290.09%、277.52%；经营现金流 23.84 亿元、同比下降 4.65%。光模块收入 53.51 亿元、毛利率 39.33%，但客户、订单和可比口径未拆分。
- 资本与风险：公司拟将光芯片及光模块扩建项目总投资由 12 亿美元增至 17 亿美元；另拟向 Multek 注资 5 亿美元并新增担保额度合计 56 亿元人民币，均仍需股东会审议。历史应收账款核销 1.48 亿元已全额计提、账面价值为零，不产生当期损益影响。
- 相对基线：`DSBJ-01` 获光模块实际收入与毛利的正式支撑；`DSBJ-03` 的资本开支、融资和整合压力同步上升，不能将计划外推为已投产或新增订单。
