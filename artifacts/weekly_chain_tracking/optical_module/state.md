...
| 光连接/光纤/高密度连接器 | 外部变量观察 | watch/possible regional soft | AI factory 光纤密度提升和 NVIDIA-Corning 长协可能造成区域性连接产能压力 | new/watch | Corning/NVIDIA 10x 光连接和 50%+ 光纤扩产；本周媒体称需求强和交期拉长 | N/A；缺官方单品交期和 A/台股传导证据 | Corning 扩产按期释放；客户不再锁产能；连接件二供快速认证 | 跟 Corning 5/19 J.P. Morgan TMC transcript |
...
| 光连接/光纤/连接器 | 外部变量观察 | Corning/NVIDIA 是否传导到 MT/FAU/连接器和 A/台股公司 | 光纤扩产不等于模块上游单品短缺 |
...
- 次级跟踪 3：光连接、OCS/CPO、主动对准/测试和光引擎制造卡点迁移。
...
| Corning | GLW.US | 美股 | 光连接、光纤、AI 数据中心光连接产能 | 外部变量升温 |
