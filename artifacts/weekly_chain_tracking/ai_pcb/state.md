...
| 台光电、台燿、联茂、建滔、生益、南亚是否披露 M8/M9/M10 CCL/prepreg 分产品 lead time、报价有效期、客户提前锁料或二供认证 | 部分证实，仍待跟踪 | 台系涨价、强营收、板厂材料偏紧和 2026-06-22 邮件中的建滔单张毛利线索共同支持 CCL/prepreg `soft_bottleneck+`，但建滔 80 元单张毛利仍是 mixed-source，缺官方逐产品 lead time、报价有效期、锁料和 A 股分产品收入/毛利证据。 |
...
3. 台光电、台燿、联茂、建滔、生益、南亚是否披露 M8/M9/M10 CCL/prepreg 报价有效期、客户锁料、二供认证、lead time、分产品收入或毛利；建滔单张毛利 80 元只能在公司/客户/法说/财报证实后升级。
