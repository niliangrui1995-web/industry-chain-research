...
| HVLP/VLP/RTF PCB 铜箔 | 次级跟踪 | `watch_to_soft` | 表面处理、低粗糙度一致性、添加剂配方、客户认证和进口供应集中限制高端供给；锂电铜箔不能替代 PCB 级铜箔 | `watch_priority_up` | Mitsui 官方确认高端 HVLP 需求增长和扩产；金居董事长媒体采访称 HVLP4 缺口扩大并规划 2027 新产能；DIGITIMES/市场人士称 2026/2027 缺口 1500/2500 吨；诺德 IR 仍显示 HVLP4 测试、HVLP5 开发 | 2026H2-2027 watch_to_soft；持续时间 N/A，缺 HVLP4/5 多客户批量收入、客户和毛利证据 | 国内外多供应商稳定量产，并被 CCL/板厂客户认证 | PCB 级 HVLP4/5 多客户批量供货、加工费回落、国产良率确认 | 查 Mitsui/Co-Tech/德福/诺德/嘉元/铜冠 PCB 级 HVLP4/5 交付、收入、加工费、客户和毛利证据 |
