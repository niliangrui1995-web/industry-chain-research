...
当前阶段：第八期全链雷达，已吸收光模块专项 2026-06-14 状态与 AI PCB 专项 2026-06-14 状态。
...
1. `HBM / server DRAM / LPDRAM / NAND / enterprise SSD / AI server parts supply`：维持并强化全链最硬 `hard_bottleneck`。HPE 官方 transcript 把 DRAM/NAND 成本和 supply constraints、AI systems backlog、memory availability 对 2027 转化节奏的影响升为 A 级证据；TrendForce 新增 enterprise SSD supply crunch 与 LPDRAM supply bottleneck。预计 `2026H2-2027H1`，慢 ramp 可延至 `2027H2`。
