...
更新时间：2026-06-08
最新报告：`artifacts/weekly_chain_tracking/ai_chain/2026-06-08.md`
覆盖窗口：2026-06-01 至 2026-06-08，北京时间
当前阶段：第七期全链雷达，已吸收光模块专项 2026-06-07 状态与 AI PCB 专项 2026-06-08 状态。
...
1. `HBM / server DRAM / NAND / enterprise SSD / AI server parts supply`：维持全链最硬 `hard_bottleneck`。HPE Q2 FY26、Broadcom Q2 FY26、TrendForce DRAM/HBM、NVIDIA Vera Rubin、Samsung/NVIDIA HBM4 collaboration、Micron HBM4 共同强化需求和供应资格路径。HBM4/HBM4E 缓解路径变清晰，但不能视作当前短缺解除。预计 `2026H2-2027H1`，若 HBM4E/eSSD/CPU/packaging ramp 慢可延至 `2027H2`。
2. `高端 EML / InP / CW-DFB / pump / ELS / 1.6T 光互连组件`：吸收光模块专项，维持 `hard_bottleneck`。TrendForce 6/3、Ciena、Lumentum 和专项状态继续支持光源/InP 硬卡点。预计 EML/InP `2026H2-2027H1`，CW/pump/ELS/CPO 可到 `2027H2-2028H1`。
3. `M7/M8/M9/M10 CCL / prepreg + 高端电子布 / HVLP`：吸收 AI PCB 专项，维持 `soft_bottleneck+`。AI PCB 专项 2026-06-08 确认 CCL/prepreg 是当前最明确材料卡点，高端电子布为 soft；HVLP4/5 批量短缺证据不足，保持 `watch`。预计 CCL `2026H2-2027H1`；电子布 `2026H2-2027H1`；Q cloth/石英布偏 `2027H2-2028`。
4. `数据中心电力 / 并网 / 800VDC / rack power / 液冷`：维持全链 `soft_bottleneck`，PJM/Ohio/PA 区域按 `regional hard operational bottleneck`。区域并网预计 `2026H2-2030`，全球设备/rack power/液冷预计 `6-24 个月`，单品交期仍 `N/A`。
5. `CoWoS / EFB / SoIC / advanced packaging / substrate`：维持 `soft_bottleneck/watch+`，不升 hard。需求强，但缺 TSMC/OSAT 官方交期、allocation、良率或客户排产延期。预计 `2026H2-2027H1` 偏紧，2027 后边际缓解。
6. `AI networking switch ASIC / NIC / DPU / retimer / custom XPU`：维持 `strategic_watch/watch_to_soft`。Broadcom/NVIDIA 证明需求强，但未见 networking silicon、substrate 或 package 供应短缺、lead time 或 allocation。
...
| AI PCB 及上游 | `artifacts/weekly_chain_tracking/ai_pcb/state.md` | M7/M8/M9/M10 CCL/prepreg soft confirmed；高端电子布 soft；HVLP4/5 watch；板厂良率/测试 watch | PCB 材料链排当前核心卡点第 3；M9/M10/Q cloth/HVLP/板厂测试列未来迁移池 |

## 当前全链堵点账本

| 节点 | 所属赛道 | 状态 | 严重程度 | 造成堵点的机制 | 本期变化 | 关键证据 | 预计持续时间 | 反转指标 | 下次动作 |
|---|---|---|---|---|---|---|---|---|---|
| HBM / HBM4E / HBM4 / server DRAM / NAND / enterprise SSD | 存储 | 当前主堵点 | hard_bottleneck | AI server、agentic inference 和 custom ASIC 需求超过合格 memory/storage 供给；DRAM wafer allocation、HBM 堆叠/测试、HBM4E/HBM4 认证、NAND/eSSD 产能、LTA 锁量共同约束 | unchanged/strengthened; easing path clearer | HPE Q2 FY26、Broadcom Q2 FY26、TrendForce、NVIDIA/Samsung/Micron | 2026H2-2027H1；可延至 2027H2 | DRAM/NAND/HBM 价格涨幅收敛、库存回升、多供方 HBM4/HBM4E 认证 | 跟 HPE 10-Q/transcript、Micron/SK hynix/Samsung、Dell/HPE/SMCI |
...
| M7/M8/M9/M10 CCL / prepreg | AI PCB/材料 | 当前软堵点 | soft_bottleneck+ | 低损耗配方、特种电子布、HVLP、树脂、层压良率和客户 AVL 共同约束 | unchanged_to_worsened | AI PCB 专项、台光电/台燿/联茂 5 月营收、DigiTimes/Vexos lead-time | 2026H2 中高置信；2027H1 中等置信 | 报价停涨/回落，lead time 回常态，二供进入 AVL | 交给 PCB 专项跟台系 6 月营收、M8/M9/M10 lead time |
| 高端电子布 / Low CTE / T-glass / Low Dk/Df / Q cloth | PCB 上游材料 | 当前软堵点 | soft_bottleneck | 窑炉、拉丝、织布、后处理、良率和客户认证约束 | strengthened | AI PCB 专项：中材科技、沪电、行业研究 | 2026H2-2027H1；Q cloth/石英布 2027H2-2028 | 高端布库存恢复、报价回落、交期缩短 | 跟分产品交期、配额和 AVL |
| HVLP/VLP/RTF PCB 铜箔 | PCB 上游 | 候选卡点 | watch | 低粗糙度一致性、表面处理、添加剂和客户认证约束；HVLP4/5 批量证据不足 | unchanged | AI PCB 专项：诺德 HVLP1/2/3，HVLP4 测试，HVLP5 开发；德福扩产 | 2026H2-2027 watch；精确持续 N/A | HVLP4/5 多客户批量供货、加工费回落 | 跟德福/诺德/嘉元/铜冠 |
...
| transformer / switchgear / UPS / busway / rack PDU / CDU / 冷板 | 电力/热管理 | 当前软堵点观察 | soft_bottleneck/watch | 高功率机柜和液冷系统认证、可靠性、集成和现场交付约束 | unchanged/strengthened | JLL 2026 outlook、NVIDIA DSX、Schneider/Motivair 上期 | 6-24 个月；精确交期 N/A | CDU/冷板/PDU/transformer/switchgear 交期缩短 | 跟单品 lead time、订单纯度 |
...
| CoWoS / EFB / SoIC / advanced packaging / substrate | 先进封装 | 当前软堵点观察 | soft_bottleneck/watch+ | GPU/ASIC multi-die 和 HBM 需求推高 2.5D/3D 封装、基板、键合、测试和设备负荷 | unchanged | Broadcom、NVIDIA、TrendForce HBM | 2026H2-2027H1 偏紧，2027 后边际缓解 | TSMC/OSAT 交期恢复，客户不再锁封装产能 | 跟 TSMC/ASE/Amkor/基板/设备 |
| AI networking switch ASIC / NIC / DPU / retimer / custom XPU | 高速互连 | 战略观察 | strategic_watch/watch_to_soft | 需求强，但缺 silicon allocation、lead time 或出货受限证据 | attention_up | Broadcom Q2 FY26、NVIDIA Vera Rubin | N/A | 出现 allocation/交期则升级 | 跟 Broadcom/Marvell/NVIDIA/Arista |

## 本期深挖方向

- 主深挖 1：`HBM/DRAM/NAND/eSSD + AI server parts supply`。重点跟踪 HPE 证据官方化、HBM4/HBM4E 认证与 LTA、eSSD/NAND 价格库存、约束是否从 memory 扩散到 CPU、PCB、power/cooling。
...
| 类型 | 排名 | 对象 | 理由 | 证据等级 | 风险 |
|---|---:|---|---|---|---|
| 结构重要性 | 1 | HBM / DRAM / NAND / eSSD | AI server 与 agentic inference 的直接容量/带宽/存储约束，本期 HPE/Broadcom/NVIDIA/TrendForce 强化 | A/B | 供给释放和认证 |
...
| 交易弹性 | 4 | 美/台 networking silicon 与 ASIC 组 | Broadcom/NVIDIA 改变关注度，但缺 shortage 证据 | A/B | 预期高、非当前硬堵点 |
...
- AI PCB weekly report: `artifacts/weekly_chain_tracking/ai_pcb/2026-06-08.md`
