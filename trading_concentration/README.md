...
- 分母：
  - `2016-01-26` 前：`sh000002.day.amount + sz399107.day.amount`；
  - 自 `2016-01-26` 起：`sh880005.day.amount`。
...
该指标是基于通达信厂商盘后日线的交易活跃 A 股代理，不是官方逐日全市场成分清单。`2016-01-26` 分母切换和 `2022-08-02` 北交所纳入均会带来可比性边界。
