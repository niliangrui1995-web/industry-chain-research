---
name: banana-farmer
description: Optional momentum scanner and portfolio intelligence skill. In 产业链投研, use only as a trading-elasticity and technical-risk supplement after beneficiary evidence is established; do not use it to prove fundamental quality or real supply-chain exposure.
