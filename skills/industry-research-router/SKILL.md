...
- Company fundamentals and valuation after segment selection: `stock-fundamental-moat-triad` for value-chain position, international peer benchmarking, Porter Five Forces, and customer-certification barriers; then `stock-evaluator`, `business-analyst`, plus market-data skills according to listing market.
...
- `stock-fundamental-moat-triad` is used after segment/source selection to test exact value-chain exposure, same-node international peer competitiveness, competitive structure, and customer-entry evidence before valuation or trading-elasticity work.
