...
| 本地 `C:\zd_huatai` 数据、华泰/通达信本地日线、`vipdoc`、`T0002\blocknew`、本地板块池 | `user-investment-framework` + `ht-local-market-data` | Use as local `market_data_vendor` or `secondary_trading_context`; do not inspect account/password/order/log details by default. |
